...
but do not stop the import.`,
  ...
  fundamentus-fii-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  fundamentus-fii-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | fundamentus-fii-pp-cli import <resource> --input -`,
