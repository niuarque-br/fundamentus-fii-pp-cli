...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "fundamentus-fii-pp-cli",
		Short: "Manage fundamentus-fii resources via the fundamentus-fii API",
		Long: `Manage fundamentus-fii resources via the fundamentus-fii API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'fundamentus-fii-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("fundamentus-fii-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'fundamentus-fii-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCrawlDetalhesPromotedCmd(flags))
